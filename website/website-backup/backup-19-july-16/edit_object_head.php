<?php 
	...
	if(isset($_REQUEST['submit'])){
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_object_head set object_head_name='".$_REQUEST['object_head_name']."', object_head_code='".$_REQUEST['object_head_code']."' where object_head_id='".$_REQUEST['objectheadid']. "'");
			if($update_depart){
				echo "<meta http-equiv='Refresh' content='0; url=object_head.php'>";
				exit;
			} else { 
