	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Difference in Budget Estimates, Revised Estimates and Actual Expenditure in Union Budget</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<tr>
						...
						<td width="139" align="left"><input name="submit" type="submit" id="submit" value="Search">&nbsp;</td>
</tr>			
				<tr>
				...
				<tr>
				  <td width="123" height="25" class="txt"><strong>Year </strong></td>
				...
				<tr>
				  <td width="123" height="25" class="txt">&nbsp;</td>
				  <td width="120" align="center" class="txt">Rs Crore </td>
				  <td width="105" align="center" class="txt">In Percent</td>
				  <td width="101" height="25" align="center" class="txt">Rs Crore </td>
				  <td width="108" height="25" align="center" class="txt">In Percent </td>
				  <td width="128" height="25" align="center" class="txt">Rs Crore </td>
...
<?php
			...
			$select_budget_report="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total, budget_year from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_type='".$_REQUEST['level']."' and social_sector_type='na' group by budget_year";
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Difference in Budget Estimates, Revised Estimates and Actual Expenditure in Union Budget", " ", " ", " ", " ", " ", " "); 
			$i=0;
...
////////////////// A V E R A G E /////////////////////
/*			$select_budget_average="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_type='".$_REQUEST['level']."' and social_sector_type='na'";
...
////////////////// A V E R A G E /////////////////////	
				...
				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=UB_diff_ae_re_be_ub">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
