		...
		<td colspan="2" class="text12"><table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="left" valign="top" ><form name="form1" method="post" action=""><table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
					...
					<tr>
						<td class="backheads" align="center">Sectoral Expenditure within Budget for Children, as percentage of the Union Budget </td>
					</tr>
					<tr>
						<td align="right">&nbsp; </td>
					</tr>
...
<?php } ?>							<tr>
						...
						// For Excel File Generation
									...
									$_SESSION['report_header']=array("Sectoral Expenditure within Budget for Children, as percentage of the Union Budget", " "); 
									$i=0;
									...
									$select_sector_report="select sum(a.ae_grand_total) as ae_total, a.expend_year as year from haq_head_expend_union a LEFT JOIN haq_major_head b ON a.major_head_id=b.major_head_id where b.major_head_status='active' and b.sector_id='".$fetch_query['sector_id']."' and a.expend_type='".$_REQUEST['level']."' and a.expend_year='".$fetch_year['year_name']."' group by a.expend_year";
									...
									$select_union_budget="select budget_ae_grand_total, budget_year from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and budget_status='active' and social_sector_type='na' and budget_year='".$fetch_year['year_name']."'";
...
/*
								...
								$select_union_avg="select sum(budget_ae_grand_total) as ae_uni_total from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and budget_status='active' and budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and social_sector_type='na'";
...
*/								?>
								<!--td align="center" class="txt" colspan="2" ><?php // echo round($ae_bfc_avg, 3)."%" ; ?></td-->
								<?php
//								}else {
								?>
...
////////////////// A V E R A G E /////////////////////
							...
							<?php } }?>
							<tr>
								<td height="30" colspan="5" align="center">&nbsp;<a href="export_report.php?fn=UB_sec_exp_bfc_UB">Download in Excel</a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
