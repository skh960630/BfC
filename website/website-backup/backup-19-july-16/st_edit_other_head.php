<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_st_other_head where other_head_id='".$_REQUEST['otherheadid']."'");
	$fetch_result=mysql_fetch_array($fetch_query);
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_other_head where  other_head_id !='".$_REQUEST['otherheadid']."' and state_id='".$fetch_result['state_id']."' and sector_id='".$fetch_result['sector_id']."' and program_id='".$fetch_result['program_id']."' and major_head_id ='".$fetch_result['major_head_id']."' and sub_major_head_id ='".$fetch_result['sub_major_head_id']."' and minor_head_id ='".$fetch_result['minor_head_id']."' and sub_head_id ='".$fetch_result['sub_head_id']."' and detail_head_id ='".$fetch_result['detail_head_id']."' and object_head_id ='".$fetch_result['object_head_id']."' and other_head_name='".$_REQUEST['other_head_name']."' and other_head_code='".$_REQUEST['other_head_code']."'");
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_st_other_head set other_head_name='".$_REQUEST['other_head_name']."', other_head_code='".$_REQUEST['other_head_code']."' where other_head_id='".$_REQUEST['otherheadid']. "'");
			if($update_depart){
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  ...
			  <td width="41%" align="right"><a href="st_other_head.php" class="back_menu">View Other Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
