<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		major_head_id, sub_major_head_id, minor_head_id, gen_head_id, sub_head_id, program_id, sector_id, state_id) 
		VALUES(
		...
		'".$fetch_sub_head['major_head_id']."', '".$fetch_sub_head['sub_major_head_id']."', '".$fetch_sub_head['minor_head_id']."', '".$fetch_sub_head['gen_head_id']."', '".$fetch_sub_head['sub_head_id']."', '".$_REQUEST['program_name']."', '".$fetch_sub_head['sector_id']."', '".$fetch_sub_head['state_id']."')";
		...
		<tr>
		  ...
		  <table width="56%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  ...
			  <td width="37%" align="right"><a href="vi_sub_head_entry.php?sub_headid=<?php echo $_REQUEST['sub_headid'] ; ?>" class="back_menu">VI Schedule Entry</a>&nbsp;&nbsp;<a href="st_sub_head.php" class="back_menu">View Sub Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
