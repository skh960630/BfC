<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		major_head_id, sub_major_head_id, minor_head_id, gen_head_id, sub_head_id, detail_head_id, object_head_id, other_head_id,  program_id, sector_id, state_id, vi_sche) 
		VALUES(
		...
		'".$fetch_other_head['major_head_id']."', '".$fetch_other_head['sub_major_head_id']."', '".$fetch_other_head['minor_head_id']."', '".$fetch_other_head['gen_head_id']."', '".$fetch_other_head['sub_head_id']."', '".$fetch_other_head['detail_head_id']."', '".$fetch_other_head['object_head_id']."', '".$fetch_other_head['other_head_id']."', '".$_REQUEST['program_name']."', '".$fetch_other_head['sector_id']."', '".$fetch_other_head['state_id']."', 'yes')";
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="80%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td width="32%">&nbsp;</td>
			  <td width="34%" align="center" class="backheads">Other Head Entry </td>
			  <td width="34%" align="right"><a href="st_other_head.php" class="back_menu">View Other Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
