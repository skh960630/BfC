	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Annual Rate of Change in Budget Estimate, Revised Estimate and Actual Expenditure in Social Sector</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<?php 
			...
			$select_budget_report="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total, budget_year from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' 	and budget_type='social_sec' and budget_status='active' and social_sector_type='".$_REQUEST['level']."' group by budget_year";
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Annual Rate of Change in Budget Estimates, Revised Estimates and Actual Expenditure in Social Sector", " ", " ", " ", " ", " ", " "); 
...
////////////////// A V E R A G E /////////////////////	
				  ...
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=UB_arc_be_re_ae_SS">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
