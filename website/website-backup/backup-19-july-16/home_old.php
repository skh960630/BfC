...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
  ...
  <tr>
    <td bgcolor="#DFE6EE"><?php include ('includes/home_left.php')?></td>
  </tr>
</table>
</td>
        <td width="39%" align="left" valign="top" class="justify"><div align="center"></div></td>
        <td width="34%" align="left" valign="top" class="justify"><div align="center"><p>
             </p></div></td>
            </tr>
            <tr bgcolor="#F1F4F7">
              <td height="216" align="left" valign="top" class="justify"><div align="center">
                   </div></td>
              <td align="left" valign="top" class="justify"><div align="center">
              	   </div></td>
            </tr>
           </table></td>
          </tr>
