	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Annual Rate of Change in Budget Estimate, Revised Estimate and Actual Expenditure in State Budget</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
			<tr>
			  ...
			  <td colspan="7">&nbsp;</td>
				...
				<tr>
				  <td width="61" height="25" class="txt"><strong>Year </strong></td>
				  <td width="87" align="center" class="txt"><strong>Budget Estimate</strong></td>
				  <td width="76" height="25" align="center" class="txt"><strong>Revised Estimate</strong></td>
				  <td width="95" height="25" align="center" class="txt"><strong>Actual Expenditure</strong></td>
				  <td width="99" align="center" class="txt"><strong>Annual Rate of Change - Budget Estimate </strong></td>
				  <td width="112" align="center" class="txt"><strong>Annual Rate of Change - Revised Estimate </strong></td>
				  <td width="115" align="center" class="txt"><strong>Annual Rate of Change - Actual Expenditure</strong></td>
				</tr>
<?php 
			...
			$select_budget_report="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total, budget_year from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' 	and budget_type='".$_REQUEST['level']."' and budget_status='active' and social_sector_type='na' and state_id='".$_REQUEST['state_id']."' group by budget_year";
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Annual Rate of Change in Budget Estimates, Revised Estimates and Actual Expenditure in State Budget", " ", " ", " ", " ", " ", " "); 
...
<?php } }?>				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=ST_arc_be_re_ae_ST">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
