<?php
	...
	include ('conn.php');
			$del_other="delete from haq_admin_user where admin_id='16'";
			$del_result7=mysql_query($del_other);
	$s_query=mysql_query("select * from haq_admin_user order by admin_user_id");
	  ...
	  <td colspan="2" class="text12"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td width="50%" align="left" valign="top" bgcolor="#FFFFFF" class="justify"><table width="100%"  border="0" cellpadding="5" cellspacing="1" class="border1">
			<tr bgcolor="#BCCAD8">
			  <td colspan="4" align="center" nowrap class="backheads">State User Detail </td>
			  <td colspan="3" align="right" nowrap><a href="main_union.php?page=admin" class="back_menu"><strong>Admin Page</strong></a>&nbsp;&nbsp;<a href="home.php" class="back_menu"s><strong>Home Page</strong></a>&nbsp;&nbsp;<a href="add_user.php" class="back_menu"s><strong>Add State User</strong></a>&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr bgcolor="#BCCAD8">
			  ...
			  <td width="21%" align="center" nowrap bgcolor="#BCCAD8"><div align="left"><strong>State</strong></div></td>
			...
			<tr bgcolor="#F1F4F7">
			  ...
			  <td><div align="left">&nbsp;<?php echo $r_query['admin_state_name'] ; ?></div></td>
			  <td width="14%" align="center" bgcolor="#F1F4F7"><a href="edit_user.php?userid=<?php echo $r_query['admin_id'] ; ?>"><img src="images/edit.gif" alt="Edit" width="16" height="16" border="0"></a></td>
			  <td width="14%" colspan="2" align="center" bgcolor="#F1F4F7"><a href="user.php?action=status&statuscode=<?php echo $r_query['admin_status'] ; ?>&statusid=<?php echo $r_query['admin_id'] ; ?>"><?php echo $r_query['admin_status']?></a></td>
			</tr> 
			<?php } ?>
		  </table></td>
		</tr>
