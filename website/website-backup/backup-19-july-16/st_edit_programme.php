<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_st_program where program_id='".$_REQUEST['programid']."'");
	...
	if(isset($_REQUEST['submit'])){
		...
		if($f_query !=0){
			...
			$update_state=mysql_query("update haq_st_program set program_name='".$_REQUEST['program_name']."' where program_id='".$_REQUEST['programid']. "'");
			if($update_state){
	...
	<tr>
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="54%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="33%">&nbsp;</td>
			  <td width="35%" align="center" class="backheads"><strong>Update Programme </strong></td>
			  <td width="32%" align="right"><a href="st_programme.php" class="back_menu">View Programme</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left">
				<?
					$sel_state="select * from haq_state where state_status='active' and state_id='".$fetch_result['program_state_id']."'";
