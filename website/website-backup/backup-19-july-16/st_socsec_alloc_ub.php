		...
		<td colspan="2" class="text12"><table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			...
			<tr>
				<td align="left" valign="top" ><form name="form1" method="post" action=""><table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
					...
					<tr>
						<td class="backheads" align="center">Sectoral Allocation within Budget for Children, as percentage of the State Social Sector </td>
					</tr>
					<tr>
						<td align="right">&nbsp; </td>
					</tr>
...
-->							</tr>
						...
						// For Excel File Generation
									...
									$_SESSION['report_header']=array("Sectoral Allocation within Budget for Children, as percentage of the State Social Sector", " "); 
									$i=0;
									...
									$select_union_budget="select budget_be_grand_total, budget_year from haq_budget_report_union where budget_type='social_sec' and budget_status='active' and state_id='".$_REQUEST['state_id']."' and social_sector_type='".$_REQUEST['level']."' and budget_year='".$fetch_year['year_name']."'";
...
/*								$select_sector_avg="select sum(a.be_grand_total) as be_total from haq_head_expend_state a LEFT JOIN haq_st_major_head b ON a.major_head_id=b.major_head_id where b.major_head_status='active' and a.expend_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and a.state_id='".$_REQUEST['state_id']."' and b.sector_id='".$fetch_query['sector_id']."' and a.expend_type='".$_REQUEST['level']."' and expend_status='active'";
								...
								$select_union_avg="select sum(budget_be_grand_total) as gr_be_total from haq_budget_report_union where budget_type='social_sec' and budget_status='active' and state_id='".$_REQUEST['state_id']."' and budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and social_sector_type='".$_REQUEST['level']."'";
...
///////AVERAGE CALCULATION ENDS////////////////
							...
							<tr>
								<td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=ST_sec_all_bfc_SS">Download in Excel</a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
