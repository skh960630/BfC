	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Annual Rate of Change in Sectoral Allocation within the Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
			...
			<tr>
			  <td colspan="7" align="right" class="txt"><strong>Percent</strong>&nbsp;</td>
				...
				<tr>
				  ...
				  echo "Sector >>".$res_sector_disp['sector_name'] ; ?></strong></td>
				  </tr>
				<tr>
...
//			while($fetch_year=mysql_fetch_array($result_year)){ 
			...
			$select_budget_report="select sum(a.be_grand_total) as be_total, a.expend_year from haq_head_expend_union a LEFT JOIN haq_major_head b ON a.major_head_id=b.major_head_id where b.major_head_status='active' and a.expend_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and b.sector_id='".$_REQUEST['sector_id']."' and a.expend_type='".$_REQUEST['level']."' and a.expend_status='active' group by a.expend_year";
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Annual Rate of Change in Sectoral Allocation within the Budget for Children", " ", " "); 
...
//			$_SESSION['report_header']=array("Year", "Rs Crore", "In Percent", "Rs Crore", "In Percent", "Rs Crore", "In Percent"); 
			...
			$select_budget_bfc="select sum(a.be_grand_total) as be_bfc_total, a.expend_year from haq_head_expend_union a LEFT JOIN haq_major_head b ON a.major_head_id=b.major_head_id where b.major_head_status='active' and a.expend_year='".$fetch_budget_report['expend_year']."' and a.expend_type='".$_REQUEST['level']."' and a.expend_status='active' group by a.expend_year";
...
////////////////// A V E R A G E /////////////////////	
				...
				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=UB_arc_SA_BFC">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
