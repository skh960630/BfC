<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		$s_query=mysql_query("select * from haq_budget_report_union where budget_year='".$_REQUEST['bud_year']."' and budget_status='active' and budget_type='union'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The Union Budget for Year ' " . $_REQUEST['bud_year'] . " ' already exist.";
		} else {
		...
		VALUES(
		'active', '".$_REQUEST['bud_year']."', '".$result_year['year_code']."', 'union', 'na', 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="34%" align="center" class="backheads"><strong>Add Union Budget</strong></td>
			...
			<tr>
			  ...
			  <td width="23%" align="left"><div align="center"><span class="txt"><strong>Actual Expenditure</strong></span></div></td>
			</tr>
			<tr>
