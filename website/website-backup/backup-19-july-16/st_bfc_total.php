	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Budget Estimate, Revised Estimate and Actual Expenditure of State Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><select name="plan_cap">
                ...
                <option value="debt" >Debt Expenditure</option>
              </select></td>
				...
				<tr>
				  ...
				  if($_REQUEST['plan_cap'] =='plan'){
				  	$exp_report="Plan"; 
				   	...
				   	$exp_report="Non Plan";
				  } elseif($_REQUEST['plan_cap'] =='capital'){
				  	$exp_report="Capital";
				  } elseif($_REQUEST['plan_cap'] =='revenue'){
				  	$exp_report="Revenue";
				  } else {
					$exp_report="Total";
				  }
...
<?php
				...
				}else if ($_REQUEST['plan_cap']=='debt'){
					$query=	"sum(a.be_debt_total) as be_total, sum(a.re_debt_total) as re_total, sum(a.ae_debt_total) as ae_total, a.expend_year";		
				}else {
					$query=	"sum(a.be_grand_total) as be_total, sum(a.re_grand_total) as re_total, sum(a.ae_grand_total) as ae_total, a.expend_year";		
				}				
			$select_budget_report="select ".$query." from haq_head_expend_state a LEFT JOIN haq_st_major_head b ON a.major_head_id=b.major_head_id where b.major_head_status='active' and a.expend_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and a.state_id='".$_REQUEST['state_id']."' and a.expend_type='".$_REQUEST['level']."' and a.expend_status='active' group by a.expend_year";
 
			$result_budget_report=mysql_query($select_budget_report);
// For Excel File Generation
			unset($_SESSION['report_header']);
			unset($_SESSION['report_values']);
			$_SESSION['report_header']=array("Budget Estimate, Revised Estimate and Actual Expenditure of State Budget for Children"," "," "," "); 
				$i=0;
				...
				$i=1;
				$_SESSION['report_values'][$i][0]=Expenditure." ".Report."-".$exp_report;
				$_SESSION['report_values'][$i][1]=" ";
				$_SESSION['report_values'][$i][2]=" ";
				$_SESSION['report_values'][$i][3]=" ";
				$i=2;
...
?>				
				<tr>
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=ST_bfc">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
