<?php 
	...
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_department where department_name='".$_REQUEST['depart_name']."' and department_demand='".$_REQUEST['depart_code']."'");
		...
		if($f_query !=0){
			...
			$i_query="INSERT INTO haq_department (department_name, department_demand, ministry_id) VALUES ('".$_REQUEST['depart_name']."', '".$_REQUEST['depart_code']."', '".$_REQUEST['ministry_id']."')";
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  ...
			  <td width="42%" align="right"><a href="department.php" class="back_menu">View Department</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
