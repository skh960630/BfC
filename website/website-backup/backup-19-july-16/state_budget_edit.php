<?php
	...
	include ('conn.php');
	$state_query=mysql_query("select state_id from haq_budget_report_union where main_budget_id='".$_REQUEST['main_budget_id']."' and budget_type='state' and social_sector_type='na'");
	$state_result=mysql_fetch_array($state_query);
	$fetch_query=mysql_query("select * from haq_budget_report_union where main_budget_id='".$_REQUEST['main_budget_id']."' and budget_type='state' and social_sector_type='na'");
	...
	if (isset($_REQUEST['submit'])){ 
		...
		budget_be_revenue_plan='".$_REQUEST['rev_be_plan']."', budget_be_revenue_non_plan='".$_REQUEST['rev_be_nplan']."', budget_be_revenue_total='".$be_rev_total."', budget_be_capital_plan='".$_REQUEST['cap_be_plan']."', budget_be_capital_non_plan='".$_REQUEST['cap_be_nplan']."', budget_be_capital_total='".$be_cap_total."', budget_be_debt_plan='".$_REQUEST['debt_be_plan']."', budget_be_debt_non_plan='".$_REQUEST['debt_be_nplan']."', budget_be_debt_total='".$be_debt_total."', budget_be_plan_total='".$be_plan_total."', budget_be_non_plan_total='".$be_nplan_total."', budget_be_grand_total='".$be_grnd_total."', 
		budget_re_revenue_plan='".$_REQUEST['rev_re_plan']."', budget_re_revenue_non_plan='".$_REQUEST['rev_re_nplan']."', budget_re_revenue_total='".$re_rev_total."', budget_re_capital_plan='".$_REQUEST['cap_re_plan']."', budget_re_capital_non_plan='".$_REQUEST['cap_re_nplan']."', budget_re_capital_total='".$re_cap_total."', budget_re_debt_plan='".$_REQUEST['debt_re_plan']."', budget_re_debt_non_plan='".$_REQUEST['debt_re_nplan']."', budget_re_debt_total='".$re_debt_total."', budget_re_plan_total='".$re_plan_total."', budget_re_non_plan_total='".$re_nplan_total."', budget_re_grand_total='".$re_grnd_total."', 
		budget_ae_revenue_plan='".$_REQUEST['rev_ae_plan']."', budget_ae_revenue_non_plan='".$_REQUEST['rev_ae_nplan']."', budget_ae_revenue_total='".$ae_rev_total."', budget_ae_capital_plan='".$_REQUEST['cap_ae_plan']."', budget_ae_capital_non_plan='".$_REQUEST['cap_ae_nplan']."', budget_ae_capital_total='".$ae_cap_total."', budget_ae_debt_plan='".$_REQUEST['debt_ae_plan']."', budget_ae_debt_non_plan='".$_REQUEST['debt_ae_nplan']."', budget_ae_debt_total='".$ae_debt_total."', budget_ae_plan_total='".$ae_plan_total."', budget_ae_non_plan_total='".$ae_nplan_total."', budget_ae_grand_total='".$ae_grnd_total."' 
		where main_budget_id='".$_REQUEST['main_budget_id']."'";
		$result_budget=mysql_query($update_budget);
			if($result_budget){
			echo "<meta http-equiv='Refresh' content='0; url=state_budget.php'>";
			exit;
			}else{ 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="34%" align="center" class="backheads"><strong>Edit State Budget</strong></td>
			  <td width="41%" align="right"><a href="state_budget.php" class="back_menu">View State Budget</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td colspan="3" align="right">(Figures are in Crores)&nbsp; </td>
			</tr>
			<?php
				if($state_result['state_id']==$user_state_id or $admin_level=='super'){
			?>
			<tr>
			...
			<tr>
			  ...
			  <td colspan="3" align="left"><?php 
					$sel_state=mysql_query("select * from haq_state where state_id='".$fetch_result['state_id']."' and state_status='active' order by state_name");
					$fetch_state = mysql_fetch_array($sel_state);
			...
			<tr>
			  ...
			  <td>&nbsp;Plan :</td>
			  <td align="left"><input name="debt_be_plan" type="text" value="<?php echo $fetch_result['budget_be_debt_plan'] ; ?>" size="20"></td>
			  <td align="left"><input name="debt_re_plan" type="text" value="<?php echo $fetch_result['budget_re_debt_plan'] ; ?>" size="20"></td>
			  <td align="left"><input name="debt_ae_plan" type="text" value="<?php echo $fetch_result['budget_ae_debt_plan'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp;Non Plan :</td>
			  <td align="left"><input name="debt_be_nplan" type="text" value="<?php echo $fetch_result['budget_be_debt_non_plan'] ; ?>" size="20"></td>
			  <td align="left"><input name="debt_re_nplan" type="text" value="<?php echo $fetch_result['budget_re_debt_non_plan'] ; ?>" size="20"></td>
			  <td align="left"><input name="debt_ae_nplan" type="text" value="<?php echo $fetch_result['budget_ae_debt_non_plan'] ; ?>" size="20"></td>
			</tr>
			<tr>
			...
			<?php } else {?>
			<tr>
			  <td colspan="3" class="error" align="center">You are not the Authorised User to edit this Report</td>
			</tr>
			<?php } ?>
			<tr>
			  <td colspan="3">&nbsp; </td>
