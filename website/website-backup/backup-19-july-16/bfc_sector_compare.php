	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Difference in Budget Estimates, Revised Estimates and Actual Expenditure in Different Sectors of Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Difference in Budget Estimates, Revised Estimates and Actual Expenditure in Different Sectors of Budget for Children", " ", " ", " ", " ", " ", " "); 
...
?>			
				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=UB_diff_ae_re_be_ss_bfc">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
