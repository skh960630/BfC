	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Difference in Budget Estimates, Revised Estimates and Actual Expenditure in State Budget</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<?php
			...
			$select_budget_report="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total, budget_year from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_type='".$_REQUEST['level']."' and social_sector_type='na' and state_id='".$_REQUEST['state_id']."' group by budget_year";
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Difference in Budget Estimates, Revised Estimates and Actual Expenditure in State Budget", " ", " ", " ", " ", " ", " "); 
			$i=0;
...
/*
			$select_budget_average="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_type='".$_REQUEST['level']."' and social_sector_type='na' and state_id='".$_REQUEST['state_id']."'";
...
?>			
				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=ST_diff_ae_re_be_ST">Download in Excel</a></td>
				  </tr>
				<?php } ?>
		  </table></td>
			</tr>
