	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Budget for Children as Percentage of Union Budget </td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Budget for Children as Percentage of Union Budget"," "," "," "); 
				$i=0;
			...
			$select_union_budget="select budget_be_grand_total, budget_re_grand_total, budget_ae_grand_total, budget_year from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and social_sector_type='na' and budget_year='".$fetch_year['year_name']."'";
...
////////////////// A V E R A G E /////////////////////
				  ...
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=UB_BFC_out_Union">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
