<?php 
	...
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_ministry where ministry_name='".$_REQUEST['min_name']."' and ministry_code='".$_REQUEST['min_code']."'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The Ministry " . $_REQUEST['min_name'] . " or Code " .$_REQUEST['min_code'] . " is already in use.";
		} else {
			$i_query="INSERT INTO haq_ministry (ministry_name, ministry_code, ministry_status) VALUES ('".$_REQUEST['min_name']."', '".$_REQUEST['min_code']."', 'active')";
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="22%">&nbsp;</td>
			  <td width="38%" align="center" class="backheads"><strong>Add Ministry </strong></td>
			  <td width="40%" align="right"><a href="ministry.php" class="back_menu">View Ministry</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="min_name" type="text" value="" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp;&nbsp;&nbsp;<strong>Code : </strong></td>
			  <td colspan="2" align="left"><input name="min_code" type="text" value="" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
...
//frmvalidator.addValidation("min_code","numeric");
