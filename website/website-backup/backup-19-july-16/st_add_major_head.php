<?php 
	...
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_major_head where state_id='".$_REQUEST['state_id']."' and sector_id='".$_REQUEST['sector_id']."' and department_id='".$_REQUEST['department_id']."' and program_id='".$_REQUEST['program_id']."' and major_head_name='".$_REQUEST['major_head_name']."' and major_head_code='".$_REQUEST['major_head_code']."'");
