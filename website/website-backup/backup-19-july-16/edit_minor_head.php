<?php 
	...
	if(isset($_REQUEST['submit'])){
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_minor_head set minor_head_name='".$_REQUEST['minor_head_name']."', minor_head_code='".$_REQUEST['minor_head_code']."' where minor_head_id='".$_REQUEST['minorheadid']. "'");
			if($update_depart){
