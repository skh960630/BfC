<?php 
	...
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_program where program_name='".$_REQUEST['program_name']."' and program_state_id='".$_REQUEST['state_id']."'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The Programme " . $_REQUEST['program_name'] . " is already in use.";
		} else {
			$i_query="INSERT INTO haq_st_program (program_name, sector_id, program_state_id) VALUES ('".$_REQUEST['program_name']."', '".$_REQUEST['sector_id']."', '".$_REQUEST['state_id']."')";
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
	...
	<tr>
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		<tr>
		  <td align="right" valign="top" height="10" ><a href="main_state.php?page=entry" class="back_menu"><strong>Data Entry </strong></a>&nbsp; || &nbsp;<a href="home.php" class="back_menu"><strong>Home Page </strong></a>&nbsp;&nbsp;&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="31%">&nbsp;</td>
			  <td width="31%" align="center" class="backheads"><strong>Add Programme </strong></td>
			  <td width="38%" align="right"><a href="st_programme.php" class="back_menu">View Programme</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
