<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_st_sub_head where sub_head_id='".$_REQUEST['subheadid']."'");
	$fetch_result=mysql_fetch_array($fetch_query);
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_sub_head where  sub_head_id !='".$_REQUEST['subheadid']."' and state_id='".$fetch_result['state_id']."' and sector_id='".$fetch_result['sector_id']."' and program_id='".$fetch_result['program_id']."' and major_head_id ='".$fetch_result['major_head_id']."' and sub_major_head_id ='".$fetch_result['sub_major_head_id']."' and minor_head_id ='".$fetch_result['minor_head_id']."' and sub_head_name='".$_REQUEST['sub_head_name']."' and sub_head_code='".$_REQUEST['sub_head_code']."'");
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_st_sub_head set sub_head_name='".$_REQUEST['sub_head_name']."', sub_head_code='".$_REQUEST['sub_head_code']."' where sub_head_id='".$_REQUEST['subheadid']. "'");
			if($update_depart){
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="28%">&nbsp;</td>
			  <td width="36%" align="center" class="backheads"><strong>Update Sub Head </strong></td>
			  <td width="36%" align="right"><a href="st_sub_head.php" class="back_menu">View Sub Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
