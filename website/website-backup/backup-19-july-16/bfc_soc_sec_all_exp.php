	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Social Sector  Budget </td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Social Sector Budget"," "," "," "); 
				$i=0;
...
?>				
				<tr>
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=UB_Social_sector">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
