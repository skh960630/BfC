<?php 
	...
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_state where state_name='".$_REQUEST['state_name']."'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The State " . $_REQUEST['state_name'] . " is already in use.";
		} else {
			$i_query="INSERT INTO haq_state (state_name) VALUES ('".$_REQUEST['state_name']."')";
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="22%">&nbsp;</td>
			  <td width="36%" align="center" class="backheads"><strong>Add State </strong></td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="state_name" type="text" value="" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
