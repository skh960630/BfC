	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Share of Social Sector Expenditure in State Budget  </td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<tr>
			  ...
			  <td width="130" align="left"><input name="submit" type="submit" id="submit" value="Search">&nbsp;</td>
				</tr>
				...
				<tr>
				  <td height="25" colspan="7" class="txt">&nbsp;</td>
					...
					<tr>
					  ...
					  <td height="25" align="center" class="txt" colspan="4"><strong>Share of Social Sector Expenditure in State Budget </strong></td>
					  </tr>
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Share of Social Sector Expenditure in State Budget"," "); 
				$i=0;
				$_SESSION['report_values'][$i][0]=State." >> ".$fetch_state['state_name'];
				$_SESSION['report_values'][$i][1]=" ";
				$i=1;
				$_SESSION['report_values'][$i][0]=Year."  ";
				$_SESSION['report_values'][$i][1]=Share." ".of." ".Social." ".Sector." ".Expenditure." ".in." ".State." ".Budget." ";
				$i=2;
			while($fetch_year=mysql_fetch_array($result_year)){


			$select_union_budget="select budget_ae_grand_total, budget_year from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and social_sector_type='na' and budget_status='active' and state_id='".$_REQUEST['state_id']."' and budget_year='".$fetch_year['year_name']."'";
			$result_union_budget=mysql_query($select_union_budget);
			$fetch_union_budget=mysql_fetch_array($result_union_budget);

			$select_social_budget="select budget_ae_grand_total, budget_year from haq_budget_report_union where budget_type='social_sec' and social_sector_type='".$_REQUEST['level']."' and state_id='".$_REQUEST['state_id']."' and budget_year='".$fetch_year['year_name']."'";
			...
			$sec_all= $fetch_social_budget['budget_ae_grand_total']/$fetch_union_budget['budget_ae_grand_total']*100;
} else {
			$sec_all= 0 ;
			}
...
?>	
				...
				<tr>
				  <td class="txt" colspan="3"><strong><?php echo $fetch_union_budget['budget_year'] ; ?></strong></td>
				  <td align="center" class="txt" colspan="4"><?php echo round($sec_all, 3)."%" ; ?></td>
				  </tr>
<?php
				$i=$i+1;
}	}
...
/*			$select_union_total="select sum(budget_ae_grand_total) as ae_total from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and social_sector_type='na' and state_id='".$_REQUEST['state_id']."' and budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_status='active'";
			$result_union_total=mysql_query($select_union_total);
			$fetch_union_total=mysql_fetch_array($result_union_total);

			$select_social_total="select sum(budget_ae_grand_total) as soc_total from haq_budget_report_union where budget_type='social_sec' and state_id='".$_REQUEST['state_id']."' and budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and social_sector_type='".$_REQUEST['level']."'";
			$result_social_total=mysql_query($select_social_total);
			$fetch_social_total=mysql_fetch_array($result_social_total);

			if($fetch_union_total['ae_total'] !=0){
			$sec_total= $fetch_social_total['soc_total']/$fetch_union_total['ae_total']*100;
} else { 
			$sec_total= 'N/A';
			}
...
///////AVERAGE CALCULATION ENDS////////////////
				...
				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=ST_expnditure_sectorwise">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
