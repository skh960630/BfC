	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Budget Estimate, Revised Estimate and Actual Expenditure in Different Sectors of State Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="submit" type="submit" id="submit" value="Search">&nbsp;</td>
				...
				<tr>
				  ...
				  <td width="195" height="25" align="center" class="txt"><strong>Actual Expenditure</strong></td>
			    </tr>
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Budget Estimate, Revised Estimate and Actual Expenditure in Different Sectors of State Budget for Children"," "," "," "); 
				$i=0;
...
?>			
				<tr>
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=ST_sectorwise_bfc">Download in Excel</a></td>
				  </tr>
				<?php } ?>
		  </table></td>
			</tr>
