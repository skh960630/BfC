<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		major_head_id, sub_major_head_id, minor_head_id, gen_head_id, sub_head_id, detail_head_id, program_id, sector_id, state_id, vi_sche) 
		VALUES(
		...
		'".$fetch_detail_head['major_head_id']."', '".$fetch_detail_head['sub_major_head_id']."', '".$fetch_detail_head['minor_head_id']."', '".$fetch_detail_head['gen_head_id']."', '".$fetch_detail_head['sub_head_id']."', '".$fetch_detail_head['detail_head_id']."', '".$_REQUEST['program_name']."', '".$fetch_detail_head['sector_id']."', '".$fetch_detail_head['state_id']."', 'yes')";
		...
		<tr>
		  ...
		  <table width="80%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  ...
			  <td width="34%" align="right"><a href="st_detail_head.php" class="back_menu">View Detail Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
