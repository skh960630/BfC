<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_admin_user where admin_id='".$_REQUEST['userid']."'");
	$fetch_result=mysql_fetch_array($fetch_query);
	if(isset($_REQUEST['submit'])){

		$s_query=mysql_query("select * from haq_admin_user where admin_user_id='".$_REQUEST['user_id']."' and admin_id !='".$_REQUEST['userid']."'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The User ID " . $_REQUEST['user_id'] . " is already in use.";
		} else {
			$update_state=mysql_query("update haq_admin_user set admin_name='".$_REQUEST['user_name']."', admin_user_id='".$_REQUEST['user_id']."', admin_password='".$_REQUEST['user_password']."' where admin_id='".$_REQUEST['userid']. "'");
			if($update_state){
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="33%" align="center" class="backheads"><strong>Update State User</strong></td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><strong><?php echo $fetch_result['admin_state_name'] ; ?></strong></td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="user_password" type="password" value="<?php echo $fetch_result['admin_password'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp;&nbsp;&nbsp;<strong>Confirm Password :</strong></td>
			  <td colspan="2" align="left"><input name="confirm_password" type="password" value="<?php echo $fetch_result['admin_password'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
