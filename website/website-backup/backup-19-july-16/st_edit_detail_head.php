<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_st_detail_head where detail_head_id='".$_REQUEST['detailheadid']."'");
	$fetch_result=mysql_fetch_array($fetch_query);
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_detail_head where  detail_head_id !='".$_REQUEST['detailheadid']."' and state_id='".$fetch_result['state_id']."' and sector_id='".$fetch_result['sector_id']."' and program_id='".$fetch_result['program_id']."' and major_head_id ='".$fetch_result['major_head_id']."' and sub_major_head_id ='".$fetch_result['sub_major_head_id']."' and minor_head_id ='".$fetch_result['minor_head_id']."' and sub_head_id ='".$fetch_result['sub_head_id']."' and detail_head_name='".$_REQUEST['detail_head_name']."' and detail_head_code='".$_REQUEST['detail_head_code']."'");
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_st_detail_head set detail_head_name='".$_REQUEST['detail_head_name']."', detail_head_code='".$_REQUEST['detail_head_code']."' where detail_head_id='".$_REQUEST['detailheadid']. "'");
			if($update_depart){
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="26%">&nbsp;</td>
			  <td width="33%" align="center" class="backheads"><strong>Update Detail Head </strong></td>
			  <td width="41%" align="right"><a href="st_detail_head.php" class="back_menu">View Detail Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="detail_head_name" type="text" value="<?php echo $fetch_result['detail_head_name'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp;&nbsp;&nbsp;<strong>Code : </strong></td>
			  <td colspan="2" align="left"><input name="detail_head_code" type="text" value="<?php echo $fetch_result['detail_head_code'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
