<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		$s_query=mysql_query("select * from haq_budget_report_union where budget_year='".$_REQUEST['bud_year']."' and budget_status='active' and budget_type='state' and state_id='".$_REQUEST['state_id']."'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$state_name=mysql_fetch_array(mysql_query("select * from haq_state where state_id='".$_REQUEST['state_id']."'"));
			$error= "Sorry, The Budget for ' " .$state_name['state_name']. " ' for Year ' " . $_REQUEST['bud_year'] . " ' already exist.";
		} else {
		...
		budget_be_debt_plan, budget_be_debt_non_plan, budget_be_debt_total, 
		...
		budget_re_debt_plan, budget_re_debt_non_plan, budget_re_debt_total, 
		...
		budget_ae_debt_plan, budget_ae_debt_non_plan, budget_ae_debt_total, 
		budget_ae_plan_total, budget_ae_non_plan_total, budget_ae_grand_total) 
		VALUES(
		'active', '".$_REQUEST['bud_year']."', '".$result_year['year_code']."', 'state', 'na', '".$_REQUEST['state_id']."', 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="34%" align="center" class="backheads"><strong>Add State Budget</strong></td>
