...
<head>
<script src="get_program.js"></script>
<title></title>
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Budget Estimate, Revised Estimate and Actual Expenditure in Different Programmes of Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
			...
			<tr>
			  ...
			  <td colspan="4" align="left"><select name="sector_id" onChange="showUser(this.value)">
			...
			<tr>
			  ...
			  <td colspan="2" align="left" id="txtHint"><select name="program_id" >
				<option value="" selected>Select</option>
			  </select></td>
			  <td colspan="2" align="left"><input name="submit" type="submit" id="submit" value="Search">&nbsp;</td>
				...
				<tr>
				  <td height="25" colspan="6" class="txt"><strong><?php 
					...
					$pro_search=mysql_fetch_array(mysql_query("select program_name from haq_program where program_id='".$_REQUEST['program_id']."'"));
					if($sec_search['sector_name'] !='' && $pro_search['program_name'] !=''){
					  echo "Search Result for : " .$sec_search['sector_name'] ." >> " .$pro_search['program_name'] ; 
					  }
					?></strong></td>
				  </tr>
				<tr>
...
<?php
			...
			$select_budget_report="select sum(a.be_grand_total) as be_total, sum(a.re_grand_total) as re_total, sum(a.ae_grand_total) as ae_total, a.expend_year from haq_head_expend_union a LEFT JOIN haq_major_head b ON a.major_head_id=b.major_head_id where a.expend_status='active' and a.program_id='".$_REQUEST['program_id']."' and a.sector_id='".$_REQUEST['sector_id']."' and a.expend_type='".$_REQUEST['level']."' group by a.expend_year";
			$result_budget_report=mysql_query($select_budget_report);
// For Excel File Generation
			unset($_SESSION['report_header']);
			unset($_SESSION['report_values']);
			$_SESSION['report_header']=array("Budget Estimate, Revised Estimate and Actual Expenditure in Different Programmes of Budget for Children"," "," "," "); 
				$i=0;
				$_SESSION['report_values'][$i][0]=$sec_search['sector_name'] ." >> " .$pro_search['program_name'];
...
?>			
				<tr>
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=UB_Programme_bfc">Download in Excel</a></td>
				  </tr>
				<?php } ?>
		  </table></td>
			</tr>
