	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="33%" align="center" class="backheads"><strong>Update Guest User</strong></td>
			  <td width="42%" align="right"><a href="guest.php" class="back_menu">View Guest User</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
