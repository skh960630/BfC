<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		$s_query=mysql_query("select * from haq_budget_report_union where budget_year='".$_REQUEST['bud_year']."' and budget_status='active' and budget_type='social_sec' and social_sector_type='union'");
		$f_query=mysql_num_rows($s_query);
		if($f_query !=0){
			$error= "Sorry, The Social Sector Budget for Union for Year ' " . $_REQUEST['bud_year'] . " ' already exist.";
		} else {
		...
		budget_status, budget_year, budget_year_code, budget_type, social_sector_type, 
		...
		VALUES(
		'active', '".$_REQUEST['bud_year']."', '".$result_year['year_code']."', 'social_sec', 'union', 
		...
		$result_budget=mysql_query($insert_budget);
			if($result_budget){
			echo "<meta http-equiv='Refresh' content='0; url=social_sector.php'>";
			exit;
			}else{ 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td width="25%">&nbsp;</td>
			  <td width="34%" align="center" class="backheads"><strong>Social Sector Entry  </strong></td>
			  <td width="41%" align="right"><a href="social_sector.php" class="back_menu">View Social Sector </a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td width="21%" align="left"><div align="center"><span class="txt"><strong>Revised Estimate</strong></span></div></td>
