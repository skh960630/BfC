<?php 
	...
	include ('conn.php');
	$fetch_query=mysql_query("select * from haq_st_object_head where object_head_id='".$_REQUEST['objectheadid']."'");
	$fetch_result=mysql_fetch_array($fetch_query);
	if(isset($_REQUEST['submit'])){
		$s_query=mysql_query("select * from haq_st_object_head where  object_head_id !='".$_REQUEST['objectheadid']."' and state_id='".$fetch_result['state_id']."' and sector_id='".$fetch_result['sector_id']."' and program_id='".$fetch_result['program_id']."' and major_head_id ='".$fetch_result['major_head_id']."' and sub_major_head_id ='".$fetch_result['sub_major_head_id']."' and minor_head_id ='".$fetch_result['minor_head_id']."' and sub_head_id ='".$fetch_result['sub_head_id']."' and detail_head_id ='".$fetch_result['detail_head_id']."' and object_head_name='".$_REQUEST['object_head_name']."' and object_head_code='".$_REQUEST['object_head_code']."'");
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_st_object_head set object_head_name='".$_REQUEST['object_head_name']."', object_head_code='".$_REQUEST['object_head_code']."' where object_head_id='".$_REQUEST['objectheadid']. "'");
			if($update_depart){
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			<tr>
			  <td width="27%">&nbsp;</td>
			  <td width="32%" align="center" class="backheads"><strong>Update Object Head </strong></td>
			  <td width="41%" align="right"><a href="st_object_head.php" class="back_menu">View Object Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
			...
			<tr>
			  ...
			  <td colspan="2" align="left"><input name="object_head_name" type="text" value="<?php echo $fetch_result['object_head_name'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp;&nbsp;&nbsp;<strong>Code : </strong></td>
			  <td colspan="2" align="left"><input name="object_head_code" type="text" value="<?php echo $fetch_result['object_head_code'] ; ?>" size="20"></td>
			</tr>
			<tr>
			  <td>&nbsp; </td>
