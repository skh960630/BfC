...
<?php
			...
			$select_union_budget="select budget_be_grand_total, budget_re_grand_total, budget_ae_grand_total, budget_year from haq_budget_report_union where budget_type='".$_REQUEST['level']."' and social_sector_type='na' and budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' group by budget_year";
