<?php
	...
	if (isset($_REQUEST['submit'])){ 
		...
		major_head_id, sub_major_head_id, minor_head_id, sub_head_id, detail_head_id, object_head_id, program_id, sector_id) 
		VALUES(
		...
		'".$fetch_object_head['major_head_id']."', '".$fetch_object_head['sub_major_head_id']."', '".$fetch_object_head['minor_head_id']."', '".$fetch_object_head['sub_head_id']."', '".$fetch_object_head['detail_head_id']."', '".$fetch_object_head['object_head_id']."', '".$_REQUEST['program_name']."', '".$fetch_object_head['sector_id']."')";
		$result_budget=mysql_query($insert_budget);
		$update_program=mysql_query("update haq_major_head set program_id='".$_REQUEST['program_name']."' where major_head_id='".$fetch_object_head['major_head_id']."'");
			if($result_budget){
			echo "<meta http-equiv='Refresh' content='0; url=object_head.php?level=union'>";
			exit;
			}else{ 
		...
		<tr>
		  ...
		  <table width="50%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  ...
			  <td width="41%" align="right"><a href="object_head.php" class="back_menu">View Object Head</a>&nbsp;&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td colspan="3" align="left"><select name="program_name">
				...
				<?
					$sel_prog="select * from haq_program where program_status='active' and sector_id='".$fetch_object_head['sector_id']."' order by program_id";
