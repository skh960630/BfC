<?php 
	...
	if(isset($_REQUEST['submit'])){
		...
		if($f_query !=0){
			...
			$update_depart=mysql_query("update haq_detail_head set detail_head_name='".$_REQUEST['detail_head_name']."', detail_head_code='".$_REQUEST['detail_head_code']."' where detail_head_id='".$_REQUEST['detailheadid']. "'");
			if($update_depart){
