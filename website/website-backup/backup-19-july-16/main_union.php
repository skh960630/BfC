		...
		<td colspan="2" bgcolor="#FFFFFF" class="text12"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" >
			<tr bgcolor="#F1F4F7">
				<td width="27%" rowspan="2" align="left" valign="top" class="justify"><table width="71%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td bgcolor="#DFE6EE"><?php include ('includes/main_union_left.php')?></td>
					</tr>
				</table></td>
			...
			<tr bgcolor="#F1F4F7">
				<td height="216" width="100%" align="left" valign="top" class="justify"><table width="96%" border="0" align="left" cellpadding="0" cellspacing="0">
					<tr>
						<td align="right" valign="top" class="backheads"><a href="union_home.php" class="back_menu"><strong>Union Page</strong></a>&nbsp; || &nbsp;<a href="home.php" class="back_menu"><strong>Home Page</strong></a>&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
						<td align="left">&nbsp;</td>
					</tr>
