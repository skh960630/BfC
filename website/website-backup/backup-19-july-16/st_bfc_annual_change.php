	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">Annual Rate of Change in Budget Estimate, Revised Estimate and Actual Expenditure in the State Budget for Children</td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<tr>
			  ...
			  <td colspan="7">&nbsp;</td>
				...
				<tr>
				  <td width="66" height="25" class="txt"><strong>Year </strong></td>
				  <td width="79" align="center" class="txt"><strong>Budget Estimate</strong></td>
				  <td width="71" height="25" align="center" class="txt"><strong>Revised Estimate</strong></td>
				  <td width="92" height="25" align="center" class="txt"><strong>Actual Expenditure</strong></td>
				  <td width="118" align="center" class="txt"><strong>Annual Rate of Change - Budget Estimate </strong></td>
				  <td width="108" align="center" class="txt"><strong>Annual Rate of Change - Revised Estimate </strong></td>
				  <td width="111" align="center" class="txt"><strong>Annual Rate of Change - Actual Expenditure</strong></td>
				</tr>
<?php 
...
// For Excel File Generation
			...
			$_SESSION['report_header']=array("Annual Rate of Change in Budget Estimates, Revised Estimates and Actual Expenditure in the State Budget for Children", " ", " ", " ", " ", " ", " "); 
...
//			$_SESSION['report_header']=array("Year", "Rs Crore", "In Percent", "Rs Crore", "In Percent", "Rs Crore", "In Percent"); 
			...
			$sum_re_cro= $fetch_budget_report['re_total']/10000 ;
			$sum_ae_cro= $fetch_budget_report['ae_total']/10000 ;
...
<?php } }?>				<tr>
				  <td height="30" colspan="7" align="center">&nbsp;<a href="export_report.php?fn=ST_arc_be_re_ae_BFC">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
