	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <table width="70%" align="center" border="0" cellspacing="2" cellpadding="1" bgcolor="#F1F4F7">
			...
			<tr>
			  <td class="backheads" align="center">State Social Sector  Budget </td>
			  </tr>
			<tr>
			  <td align="right">&nbsp; </td>
			</tr>
...
<?php
			...
			$select_budget_report="select sum(budget_be_grand_total) as be_total, sum(budget_re_grand_total) as re_total, sum(budget_ae_grand_total) as ae_total, budget_year from haq_budget_report_union where budget_year_code between '".$_REQUEST['year_from']."' and '".$_REQUEST['year_to']."' and budget_type='social_sec' and budget_status='active' and state_id='".$_REQUEST['state_id']."' and social_sector_type='".$_REQUEST['level']."' group by budget_year";
 
			$result_budget_report=mysql_query($select_budget_report);
// For Excel File Generation
			unset($_SESSION['report_header']);
			unset($_SESSION['report_values']);
			$_SESSION['report_header']=array("State Social Sector Budget"," "," "," "); 
				$i=0;
...
?>				
				<tr>
				  <td height="30" colspan="6" align="center">&nbsp;<a href="export_report.php?fn=ST_Social_sector_state">Download in Excel</a></td>
				  </tr>
		  </table></td>
			</tr>
			<tr>
