...
if(isset($_POST['downloadButton'])){
  $exportFile = 'union_'.$_POST['downloadButton'];
...
}else if(!isset($_POST['unionData'])){
  header("Location: union.php");
}

$unionData = $_POST['unionData'];

$query = "Select * from `Union_$unionData`;";
$result = mysqli_query($conn, $query);
?>
    ...
    <div class="datareport">
      <table align="center">
        <div class="midcontainer" style="display: inline-block; margin-left: 10px;">
          <h2>Union <?php echo $unionData;?> Report</h2>
        </div>
        <div class="midcontainer" style="display: inline-block; margin-left: 120px;">
          <form action="" method="post" enctype="">
            <button class="downloadbutton" type="submit" name="downloadButton" value="<?php echo $unionData; ?>">
